...
use crate::config::{
    ApplicationError, bootstrap_settings::BootstrapSettings, errors::SettingsError,
    secret_manager::SecretManager, settings_registry::SettingsRegistry,
};
...
impl SettingsManager {
    ...
    pub async fn list_all_settings(
        &self,
    ) -> Vec<(String, crate::config::config_spec::ConfigValue)> {
    ...
    pub async fn get_setting_info(
        &self,
        setting_name: &str,
    ) -> Result<crate::config::config_spec::ConfigValue, SettingsError> {
    ...
    pub async fn update_setting(
        ...
        return Err(SettingsError::Application(
            ApplicationError::DatabaseConnection("TODO".to_string()),
        ));
    }
}
